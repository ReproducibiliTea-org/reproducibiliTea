...
I then put a slightly different question to the group: did we think preregistration should be used for COVID-19 research, and if so how?”. {% include image.html url="blog/preregistered_small_color.2400x2400 (1).jpeg" alt="Preregistration thumbnail. Photo credit preregistered_small_color.png by Open Science Collaboration is licensed under CC BY 4.0" align="right" %}
